...
const Login = () => {
  ...
  return (
    <div className="bg-[url('https://source.unsplash.com/random/1920x1080/?girl,couple,romance,love,sexy')] w-screen h-screen flex justify-center items-center ">
      <div className="w-[400px] h-[600px] bg-white rounded-lg flex justify-center items-start bg-opacity-70 border-[1px]">
        <div className="w-3/4 md:w-5/6 flex-col justify-center items-center mt-12">
          ...
          <div className="flex justify-between mt-0">
            <p className="text-sm mb-0">Do not have an account ?</p>
            <Link to="/register">
